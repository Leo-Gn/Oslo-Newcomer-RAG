...
def _build_prompt(
    *,
    ...
    system = (
        ...
        "Never call the supplied material the excerpts, these pages, these sources, the notes, "
        "what you provided, utdragene, or anything similar. When you must name it, call it "
        "'the official information' (in Norwegian 'den offisielle informasjonen') and treat it as "
        "singular: it says, it covers, it does not list. Keep subject and verb in agreement. "
