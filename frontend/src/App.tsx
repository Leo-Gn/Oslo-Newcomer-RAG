...
const text = {
  en: {
    ...
    examples: [
      ...
      "What documents do I need when I apply for a tax deduction card?",
      "How do I get a national identity number or D number?",
      "How do I register my move to Norway with the Tax Administration?",
      "What should EU or EEA citizens check before working in Norway?",
      "How do I book an appointment at the Service Centre for Foreign Workers?",
      "What do skilled workers need to apply for a residence permit in Norway?",
      "How do I find a doctor (fastlege) in Oslo?",
    ...
    greeting: "New to Oslo? Let's find what you need.",
  ...
  no: {
    ...
    examples: [
      "Hva bør jeg gjøre etter at jeg har flyttet til Oslo?",
      "Hvordan får jeg skattekort?",
      "Hvilke dokumenter trenger jeg for å søke om skattekort?",
      "Hvordan får jeg fødselsnummer eller D-nummer?",
      "Hvordan melder jeg flytting til Norge til Skatteetaten?",
      "Hva bør EU- eller EØS-borgere sjekke før de jobber i Norge?",
      "Hvordan bestiller jeg time hos Servicesenteret for utenlandske arbeidstakere?",
      "Hva trenger faglærte arbeidstakere for å søke om oppholdstillatelse i Norge?",
      "Hvordan finner jeg fastlege i Oslo?",
      "Hvor kan studenter finne bolig i Oslo?",
    ...
    greeting: "Ny i Oslo? La oss finne det du trenger.",
